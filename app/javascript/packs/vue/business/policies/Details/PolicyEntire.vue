    ...
    .container-fluid
      .row
        ...
        .col
          ...
          .row
            .col-12
              template(v-for='(policy, policyIndex) in policiesComputed')
                .row
    ...
    methods: {
      ...
      archivePolicy(policyId, archiveStatus) {
        this.$store
          ...
          .catch(error => {
            console.error(error)
            this.toast('Error', `Action has not been completed. Please try again.`, true)
          })
      },
      deleteAllSections(){
      ...
      updatePolicy() {
        ...
        this.$store
          ...
          .then((response) => {
            ...
            this.toast('Success', `Policy has been saved.`)
      ...
      movePolicy(event) {
        ...
        this.$store.dispatch("moveUpPolicy", arrToChange)
